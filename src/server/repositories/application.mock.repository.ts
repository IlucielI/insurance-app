  ...
  private applications: PolicyApplication[] = [
    ...
    },
    {
      ...
      identity: {
        ...
        ktpImageName: 'ktp-bayu-sample.jpg',
      },
      financial: {
      ...
      pillarChecks: [
        ...
        },
        {
          ...
          pillarType: 'medical_required',
          title: 'Skrining Medis & Gaya Hidup',
          description: 'Bebas penyakit kritis, bukan perokok, dan BMI normal.',
          status: 'PASSED',
          statusText: '✓ BMI 23.2 Sehat & Normal',
        },
        {
          pillarNumber: 4,
          pillarType: 'documents_complete',
          title: 'Legalitas & Beneficiary',
          description: 'Penunjukan ahli waris 100% sah dan klausul perlindungan OJK disetujui.',
          status: 'PASSED',
          statusText: '✓ Dokumen Legalitas Lengkap',
        },
      ],
      overallStatus: 'rfi_requested',
      underwritingTier: 'full_underwriting',
      ...
      timelineEvents: [
        {
          ...
          description:
            'Underwriter meminta unggah ulang e-KTP tajam dan slip gaji 3 bulan terakhir.',
          status: 'action_required',
        },
        {
          title: 'Evaluasi Otomatis 4-Pilar',
          timestamp: '2026-09-07T01:32:00.000Z',
          description: 'Pilar 1 dan 2 memerlukan dokumen klarifikasi tambahan.',
          status: 'completed',
        },
        {
          title: 'Aplikasi Diterima Sistem',
          timestamp: '2026-09-07T01:30:00.000Z',
          description: 'Pengajuan aplikasi Secure Life Plus sebesar Rp 1.000.000.000.',
          status: 'completed',
        },
      ],
    },
